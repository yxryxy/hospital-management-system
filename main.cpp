...
void pharmaciesMenu()
{
    ...
    while (!exit)
    {
        ...
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "./HOME/PHARMACIES\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "[01] : Fetach details of all drugs\n";
        cout << "[02] : Get details of some drug\n";
        cout << "[03] : Dispensing drug\n";
        cout << "[04] : Purchase drug\n\n";
        cout << "[-1] : Back\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
        cout << "Enter your choice: ";
        cin >> purpose;
...
void financeMenu()
{
    ...
    while (!exit)
    {
        ...
        cout << "./HOME/FINANCE\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "[01] : Financial inquiry\n";
        cout << "[02] : Financial expenditure inquiry\n";
        cout << "[03] : Financial revenue query\n";
        cout << "[-1] : Back\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
        cout << "Enter your choice: ";
        cin >> purpose;
        ...
        if (purpose == 1)
        {
            hospital::printFinance();
        }
        else if (purpose == 2)
        {
            hospital::printChargeFinance();
        }
        else if (purpose == 3)
        {
            hospital::printIncomeFinance();
        }
        else if (purpose == -1)
        {
            exit = true;
...
void wardsMenu()
{
    ...
    while (!exit)
    {
        ...
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        cout << "[01] : Add a ward\n";
        cout << "[02] : Get ward details\n";
        cout << "[03] : Remove a ward\n";
        cout << "[04] : Get details of all registered wards\n\n";
        cout << "[-1] : Back\n";
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
        cout << "Enter your choice: ";
        cin >> purpose;
